...
#include "cc_tools_qt_plugin/Message/cc_mqtt311/frame/FrameProtTransportMessage.h"
...
class FrameTransportMessageImpl : public
    cc_tools_qt::ToolsTransportMessageBase<
        ...
        cc_mqtt311::frame::FrameProtTransportMessage,
...
protected:
    ...
    {
        return static_cast<qlonglong>(msg().field_idAndFlags().getValue());
    }
};
