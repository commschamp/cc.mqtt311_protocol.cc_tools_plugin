...
#include "cc_tools_qt_plugin/cc_mqtt311/field/MsgId.h"
...
struct IdAndFlagsLayer
{
    struct IdAndFlagsFieldMembers
    {
        static QVariantMap createProps_flags(bool serHidden)
        {
            ...
            using Field = ::cc_mqtt311::frame::FrameLayers<cc_tools_qt_plugin::cc_mqtt311::options::DefaultOptions>::IdAndFlagsMembers::IdAndFlagsFieldMembers::Flags;
            return
        ...
        {
            static_cast<void>(serHidden);
            using Field = ::cc_mqtt311::frame::FrameLayers<cc_tools_qt_plugin::cc_mqtt311::options::DefaultOptions>::IdAndFlagsMembers::IdAndFlagsFieldMembers::Id;
            auto props = cc_tools_qt_plugin::cc_mqtt311::field::createProps_msgId(Field::name(), serHidden);
            return props;
        }
    }; // struct IdAndFlagsFieldMembers
    ...
    {
        static_cast<void>(serHidden);
        using Field = ::cc_mqtt311::frame::FrameLayers<cc_tools_qt_plugin::cc_mqtt311::options::DefaultOptions>::IdAndFlagsMembers::IdAndFlagsField;
        return
            cc_tools_qt::property::field::ForField<Field>()
                .name(Field::name())
                .serialisedHidden(serHidden)
...
struct SizeLayer
{
    ...
    {
        static_cast<void>(serHidden);
        using Field = ::cc_mqtt311::frame::FrameLayers<cc_tools_qt_plugin::cc_mqtt311::options::DefaultOptions>::SizeMembers::Size;
        return
            cc_tools_qt::property::field::ForField<Field>()
                .name(Field::name())
                .serialisedHidden(serHidden)
